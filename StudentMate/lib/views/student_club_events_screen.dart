...
class StudentClubEventsScreen extends StatefulWidget {
  const StudentClubEventsScreen({Key? key}) : super(key: key);

  @override
  State<StudentClubEventsScreen> createState() =>
      _StudentClubEventsScreenState();
}

class _StudentClubEventsScreenState extends State<StudentClubEventsScreen> {
